...
export default function MovieInnerDetails({movieGenre, movieDirector, movieWriter, movieProducer, movieStudio, movieCountry}) {
    ...
    return (
        <>
        <Card className="movieDetails container m-auto p-2 my-2 d-flex flex-column space-mono-regular" style={{backgroundColor : "var(--bg-secondary)", color : "var(--text-primary)"}}>
            <Card.Body>
                {/* <Card.Text> */}
